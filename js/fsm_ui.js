var fsm = (function() {
		...
		if (localStorageAvailable()) {
			...
			$.each(keys, function(idx, key) {
				$('<li></li>', {'class':'machineName'})
					...
					.append('<div class="delete" style="display:none;" title="Delete"><img class="delete" src="images/delete.png" /></div>')
	...
	var makeState = function(stateId, displayId) {
		...
		return $('<div id="' + stateId + '" class="state" data-displayid="' + displayId + '"></div>')
			...
			.append('<div class="delete" style="display:none;"> <img class="delete" src="images/delete.png"  title="Delete"/></div>');
	};
